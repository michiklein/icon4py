...
#srun ncu -o ncu128/v2c2v_on --set full --import-source=on -k kernel .venv/bin/python3.10 model/common/tests/mklein/v2c2v.py
#srun ncu -o ncu/v2e2c2v_on --set full --import-source=on -k kernel .venv/bin/python3.10 model/common/tests/mklein/v2e2c2v.py
#srun ncu -o ncu/c2e2c2e2c_on --set full --import-source=on -k kernel .venv/bin/python3.10 model/common/tests/mklein/c2e2c2e2c.py
