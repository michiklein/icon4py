...
#srun ncu -o ncu/v2c2e_on --set full --import-source=on --force-overwrite -k kernel .venv/bin/python3.10 model/common/tests/mklein/v2c2e.py
#srun ncu -o ncu128/v2c2v_on --set full --import-source=on --force-overwrite -k kernel .venv/bin/python3.10 model/common/tests/mklein/v2c2v.py
#srun ncu -o ncu/v2e2c2v_on --set full --import-source=on --force-overwrite -k kernel .venv/bin/python3.10 model/common/tests/mklein/v2e2c2v.py
#srun ncu -o ncu/c2e2c2e2c_on --set full --import-source=on --force-overwrite -k kernel .venv/bin/python3.10 model/common/tests/mklein/c2e2c2e2c.py
...
#srun ncu -o ncu/v2e2v_on --set full --import-source=on --force-overwrite -k kernel .venv/bin/python3.10 model/common/tests/mklein/v2e2v.py
#srun ncu -o ncu/c2e2c_on --set full --import-source=on --force-overwrite -k kernel .venv/bin/python3.10 model/common/tests/mklein/c2e2c.py
#srun ncu -o ncu/c2e2v_on --set full --import-source=on --force-overwrite -k kernel .venv/bin/python3.10 model/common/tests/mklein/c2e2v.py
#srun ncu -o ncu/c2v2c_on --set full --import-source=on --force-overwrite -k kernel .venv/bin/python3.10 model/common/tests/mklein/c2v2c.py
#srun ncu -o ncu/c2v2e_on --set full --import-source=on --force-overwrite -k kernel .venv/bin/python3.10 model/common/tests/mklein/c2v2e.py
#srun ncu -o ncu/e2c2v_on --set full --import-source=on --force-overwrite -k kernel .venv/bin/python3.10 model/common/tests/mklein/e2c2v.py
#srun ncu -o ncu/e2v2c_on --set full --import-source=on --force-overwrite -k kernel .venv/bin/python3.10 model/common/tests/mklein/e2v2c.py
#srun ncu -o ncu/e2v2e_on --set full --import-source=on --force-overwrite -k kernel .venv/bin/python3.10 model/common/tests/mklein/e2v2e.py
...
#srun nsys profile --stats=true --force-overwrite=true -o nsys/apply_diffusion_w_on .venv/bin/python3.10 model/common/tests/mklein/apply_diffusion_to_w_and_compute_horizontal_gradients_for_turbulence.py
